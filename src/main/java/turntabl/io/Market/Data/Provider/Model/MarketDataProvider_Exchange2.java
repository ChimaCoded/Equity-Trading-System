...
public class MarketDataProvider_Exchange2 {
    ...
    public MarketDataProvider_Exchange2() {

    }

    public MarketDataProvider_Exchange2(double last_traded_price, double bid_price, int sell_limit, String ticker, double max_shift_price,
